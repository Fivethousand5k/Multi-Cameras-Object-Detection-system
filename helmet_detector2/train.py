...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or True:  # Calculate mAP
        ...
        save = (not opt.nosave) or (epoch%opt.save_interval is 0 and not opt.evolve)
        if save:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='yolov3-ul', help='renames results.txt to results_name.txt if supplied')
    parser.add_argument('--device', default='', help='device id (i.e. 0 or 0,1 or cpu)')
    parser.add_argument('--adam', action='store_true', help='use adam optimizer')
    parser.add_argument('--single-cls', action='store_true', help='train as single-class dataset')
    parser.add_argument('--save_interval', default=10, help='intervals to save the checkpoint')
